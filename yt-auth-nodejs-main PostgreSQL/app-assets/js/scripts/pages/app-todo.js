  ...
  if (newTaskForm.length) {
    ...
    newTaskForm.on('submit', function (e) {
      ...
      if (isValid) {
        ...
        .catch((err) => {
          console.log("Error submitting todo" , err.message);
          toastr["error"]("Problem saving task.", {
            closeButton:true,
            tapToDismiss: true,
            rtl:isRtl
          });
...
function myGeeks() {
  document.getElementById("form-modal-todo").submit();
}